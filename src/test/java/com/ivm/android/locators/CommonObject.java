...
public class CommonObject {
	...
	//locator class is public static final which means it can be accessed by all and cannot be changed.
		...
		public final static String UndoAction ="com.ivm.appraisal:id/snackbar_action";
		
		
		public final static String screenTitle = "com.ivm.appraisal:id/title";
		public final static String backArrow = "com.ivm.appraisal:id/back_arrow";
		public final static String ActionbackArrow = "com.ivm.appraisal:id/action_back_arrow";
		public final static String Home_inventory_item = "com.ivm.appraisal:id/inventory_item";
